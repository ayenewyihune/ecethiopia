            ...
            <div class="card-header">
              ...
              <div class="card-tools">
                <button class="btn btn-primary">
                  <router-link to="/dashboard/blog/add-post2" style="color: #fff; text-decoration: none;">Add Post</router-link>
                </button>
              </div>
            </div>
            <!-- /.card-header -->
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  <tr v-for="(post, index) in allPosts" v-bind:key="post.id">
                    ...
                    <td>
                      <router-link :to="`/dashboard/blog/edit-post2/${post.id}`">Edit</router-link>
