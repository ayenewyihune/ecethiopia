                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            @else
                            <router-link to="/dashboard/blog/category-list2" class="nav-link">
                                <i class="nav-icon fa fa-newspaper"></i>
                                <p>Blog Category</p>
                            </router-link>
                            @endif
                        ...
                        <li class="nav-item">
                            ...
                            @else
                            <router-link to="/dashboard/blog/post-list2" class="nav-link">
                                <i class="nav-icon fa fa-newspaper"></i>
                                <p>Blog Post</p>
                            </router-link>
                            @endif
                        ...
                        <li class="nav-item">
                            ...
                            @else
                            <router-link to="/dashboard/vacancy/category-list2" class="nav-link">
                                <i class="nav-icon fa fa-briefcase"></i>
                                <p>Vacancy Category</p>
                            </router-link>
                            @endif
                        ...
                        <li class="nav-item">
                            ...
                            @else
                            <router-link to="/dashboard/vacancy/post-list2" class="nav-link">
                                <i class="nav-icon fa fa-briefcase"></i>
                                <p>Vacancy Post</p>
                            </router-link>
                            @endif
